...
-   *N* = 114 adults (convenience sampling) to complete the following in Gorilla
    ...
    -   Baseline WM span tasks: recall dot patterns (visuospatial) and letter sets (phonological)
    -   Dual tasks (3 conditions)
...
-   Three conditions/blocks differed in arithmetic expressions:
    1.  no-spacing variation
    2.  [[**spacing-varying**]{.underline} (consistent, inconsistent, neutral)]{style="color:red;"}
...
Every condition had all working memory types and load difficulties. The only difference are the arithmetic expressions.
:::
...
## Does spacing interact with WM?

-   No significant interactions
-   Note small sample size (*N* = 34) and high education levels (\~50% had graduate school experience)
-   Perception + cognition implication
    -   Perceptual cues can be used to support VSWM (or vice versa) during math learning
