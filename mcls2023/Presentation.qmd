...
::: {.fragment .fade-in-then-out}
<img src="Presentation_files/trials/wm_test.jpeg" style="border:1px solid black"/>
:::
:::
...
- WM Stimuli -> Arith Expression -> Arith Evaluation -> WM Recall
- DVs:
...
-   Main effect of spacing and load on arithmetic accuracy
    -   Effect of load might indicate that participants might be encoding spacing to WM
